defmodule Exconv.Mapper.Cp875 do
  ...
  def to_unicode(253), do: 26 # <<26>> | ""
  def to_unicode(252), do: 26 # <<26>> | ""
  ...
  def to_unicode(237), do: 26 # <<26>> | ""
  def to_unicode(236), do: 26 # <<26>> | ""
