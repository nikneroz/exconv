defmodule Exconv.Mapper.Cp855 do
  ...
  def to_unicode(252), do: 1063 # <<208, 167>> | "Ч"
  def to_unicode(251), do: 1095 # <<209, 135>> | "ч"
  def to_unicode(250), do: 1065 # <<208, 169>> | "Щ"
  def to_unicode(249), do: 1097 # <<209, 137>> | "щ"
  def to_unicode(248), do: 1069 # <<208, 173>> | "Э"
  def to_unicode(247), do: 1101 # <<209, 141>> | "э"
  def to_unicode(246), do: 1064 # <<208, 168>> | "Ш"
  def to_unicode(245), do: 1096 # <<209, 136>> | "ш"
  def to_unicode(244), do: 1047 # <<208, 151>> | "З"
  def to_unicode(243), do: 1079 # <<208, 183>> | "з"
  def to_unicode(242), do: 1067 # <<208, 171>> | "Ы"
  def to_unicode(241), do: 1099 # <<209, 139>> | "ы"
  def to_unicode(240), do: 173 # <<194, 173>> | "­"
  def to_unicode(239), do: 8470 # <<226, 132, 150>> | "№"
  def to_unicode(238), do: 1068 # <<208, 172>> | "Ь"
  def to_unicode(237), do: 1100 # <<209, 140>> | "ь"
  def to_unicode(236), do: 1042 # <<208, 146>> | "В"
  def to_unicode(235), do: 1074 # <<208, 178>> | "в"
  def to_unicode(234), do: 1046 # <<208, 150>> | "Ж"
  def to_unicode(233), do: 1078 # <<208, 182>> | "ж"
  def to_unicode(232), do: 1059 # <<208, 163>> | "У"
  def to_unicode(231), do: 1091 # <<209, 131>> | "у"
  def to_unicode(230), do: 1058 # <<208, 162>> | "Т"
  def to_unicode(229), do: 1090 # <<209, 130>> | "т"
  def to_unicode(228), do: 1057 # <<208, 161>> | "С"
  def to_unicode(227), do: 1089 # <<209, 129>> | "с"
  def to_unicode(226), do: 1056 # <<208, 160>> | "Р"
  def to_unicode(225), do: 1088 # <<209, 128>> | "р"
  def to_unicode(224), do: 1071 # <<208, 175>> | "Я"
  def to_unicode(223), do: 9600 # <<226, 150, 128>> | "▀"
  def to_unicode(222), do: 1103 # <<209, 143>> | "я"
  def to_unicode(221), do: 1055 # <<208, 159>> | "П"
  ...
  def to_unicode(216), do: 1087 # <<208, 191>> | "п"
  def to_unicode(215), do: 1054 # <<208, 158>> | "О"
  def to_unicode(214), do: 1086 # <<208, 190>> | "о"
  def to_unicode(213), do: 1053 # <<208, 157>> | "Н"
  def to_unicode(212), do: 1085 # <<208, 189>> | "н"
  def to_unicode(211), do: 1052 # <<208, 156>> | "М"
  def to_unicode(210), do: 1084 # <<208, 188>> | "м"
  def to_unicode(209), do: 1051 # <<208, 155>> | "Л"
  def to_unicode(208), do: 1083 # <<208, 187>> | "л"
  ...
  def to_unicode(199), do: 1050 # <<208, 154>> | "К"
  def to_unicode(198), do: 1082 # <<208, 186>> | "к"
  ...
  def to_unicode(190), do: 1049 # <<208, 153>> | "Й"
  def to_unicode(189), do: 1081 # <<208, 185>> | "й"
  ...
  def to_unicode(183), do: 1080 # <<208, 184>> | "и"
  def to_unicode(182), do: 1061 # <<208, 165>> | "Х"
  def to_unicode(181), do: 1093 # <<209, 133>> | "х"
  ...
  def to_unicode(173), do: 1043 # <<208, 147>> | "Г"
  def to_unicode(172), do: 1075 # <<208, 179>> | "г"
  def to_unicode(171), do: 1060 # <<208, 164>> | "Ф"
  def to_unicode(170), do: 1092 # <<209, 132>> | "ф"
  def to_unicode(169), do: 1045 # <<208, 149>> | "Е"
  def to_unicode(168), do: 1077 # <<208, 181>> | "е"
  def to_unicode(167), do: 1044 # <<208, 148>> | "Д"
  def to_unicode(166), do: 1076 # <<208, 180>> | "д"
  def to_unicode(165), do: 1062 # <<208, 166>> | "Ц"
  def to_unicode(164), do: 1094 # <<209, 134>> | "ц"
  def to_unicode(163), do: 1041 # <<208, 145>> | "Б"
  def to_unicode(162), do: 1073 # <<208, 177>> | "б"
  def to_unicode(161), do: 1040 # <<208, 144>> | "А"
  def to_unicode(160), do: 1072 # <<208, 176>> | "а"
  def to_unicode(159), do: 1066 # <<208, 170>> | "Ъ"
  def to_unicode(158), do: 1098 # <<209, 138>> | "ъ"
  def to_unicode(157), do: 1070 # <<208, 174>> | "Ю"
  def to_unicode(156), do: 1102 # <<209, 142>> | "ю"
  def to_unicode(155), do: 1039 # <<208, 143>> | "Џ"
  def to_unicode(154), do: 1119 # <<209, 159>> | "џ"
  def to_unicode(153), do: 1038 # <<208, 142>> | "Ў"
  def to_unicode(152), do: 1118 # <<209, 158>> | "ў"
  def to_unicode(151), do: 1036 # <<208, 140>> | "Ќ"
  def to_unicode(150), do: 1116 # <<209, 156>> | "ќ"
  def to_unicode(149), do: 1035 # <<208, 139>> | "Ћ"
  def to_unicode(148), do: 1115 # <<209, 155>> | "ћ"
  def to_unicode(147), do: 1034 # <<208, 138>> | "Њ"
  def to_unicode(146), do: 1114 # <<209, 154>> | "њ"
  def to_unicode(145), do: 1033 # <<208, 137>> | "Љ"
  def to_unicode(144), do: 1113 # <<209, 153>> | "љ"
  def to_unicode(143), do: 1032 # <<208, 136>> | "Ј"
  def to_unicode(142), do: 1112 # <<209, 152>> | "ј"
  def to_unicode(141), do: 1031 # <<208, 135>> | "Ї"
  def to_unicode(140), do: 1111 # <<209, 151>> | "ї"
  def to_unicode(139), do: 1030 # <<208, 134>> | "І"
  def to_unicode(138), do: 1110 # <<209, 150>> | "і"
  def to_unicode(137), do: 1029 # <<208, 133>> | "Ѕ"
  def to_unicode(136), do: 1109 # <<209, 149>> | "ѕ"
  def to_unicode(135), do: 1028 # <<208, 132>> | "Є"
  def to_unicode(134), do: 1108 # <<209, 148>> | "є"
  def to_unicode(133), do: 1025 # <<208, 129>> | "Ё"
  def to_unicode(132), do: 1105 # <<209, 145>> | "ё"
  def to_unicode(131), do: 1027 # <<208, 131>> | "Ѓ"
  def to_unicode(130), do: 1107 # <<209, 147>> | "ѓ"
  def to_unicode(129), do: 1026 # <<208, 130>> | "Ђ"
  def to_unicode(128), do: 1106 # <<209, 146>> | "ђ"
