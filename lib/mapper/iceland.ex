defmodule Exconv.Mapper.Iceland do
  ...
  def to_unicode(224), do: <<195, 189>> # ý
  def to_unicode(223), do: <<195, 190>> # þ
  def to_unicode(222), do: <<195, 158>> # Þ
  def to_unicode(221), do: <<195, 176>> # ð
  def to_unicode(220), do: <<195, 144>> # Ð
  ...
  def to_unicode(160), do: <<195, 157>> # Ý
