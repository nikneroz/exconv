defmodule Exconv.Mapper.Cp857 do
  ...
  def to_unicode(227), do: <<195, 146>> # Ò
  ...
  def to_unicode(222), do: <<195, 140>> # Ì
  ...
  def to_unicode(216), do: <<195, 143>> # Ï
  def to_unicode(215), do: <<195, 142>> # Î
  def to_unicode(214), do: <<195, 141>> # Í
  def to_unicode(213), do: <<194, 152>> # 
  def to_unicode(212), do: <<195, 136>> # È
  def to_unicode(211), do: <<195, 139>> # Ë
  def to_unicode(210), do: <<195, 138>> # Ê
  def to_unicode(209), do: <<194, 170>> # ª
  def to_unicode(208), do: <<194, 186>> # º
  ...
  def to_unicode(199), do: <<195, 131>> # Ã
  def to_unicode(198), do: <<195, 163>> # ã
  ...
  def to_unicode(183), do: <<195, 128>> # À
  ...
  def to_unicode(167), do: <<196, 159>> # ğ
  def to_unicode(166), do: <<196, 158>> # Ğ
  ...
  def to_unicode(159), do: <<197, 159>> # ş
  def to_unicode(158), do: <<197, 158>> # Ş
  ...
  def to_unicode(152), do: <<196, 176>> # İ
  def to_unicode(151), do: <<195, 185>> # ù
  def to_unicode(150), do: <<195, 187>> # û
  ...
  def to_unicode(141), do: <<196, 177>> # ı
  def to_unicode(140), do: <<195, 174>> # î
  def to_unicode(139), do: <<195, 175>> # ï
