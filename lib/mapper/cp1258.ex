defmodule Exconv.Mapper.Cp1258 do
  def to_unicode(255), do: <<195, 191>> # ÿ
  def to_unicode(254), do: <<226, 130, 171>> # ₫
  def to_unicode(253), do: <<198, 176>> # ư
  ...
  def to_unicode(245), do: <<198, 161>> # ơ
  def to_unicode(244), do: <<195, 180>> # ô
  def to_unicode(243), do: <<195, 179>> # ó
  def to_unicode(242), do: <<204, 163>> # ̣
  ...
  def to_unicode(236), do: <<204, 129>> # ́
  ...
  def to_unicode(222), do: <<204, 131>> # ̃
  def to_unicode(221), do: <<198, 175>> # Ư
  ...
  def to_unicode(213), do: <<198, 160>> # Ơ
  def to_unicode(212), do: <<195, 148>> # Ô
  def to_unicode(211), do: <<195, 147>> # Ó
  def to_unicode(210), do: <<204, 137>> # ̉
  ...
  def to_unicode(204), do: <<204, 128>> # ̀
