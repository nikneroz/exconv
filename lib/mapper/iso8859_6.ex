defmodule Exconv.Mapper.Iso8859_6 do
  def to_unicode(242), do: <<217, 146>> # ْ
  def to_unicode(241), do: <<217, 145>> # ّ
  def to_unicode(240), do: <<217, 144>> # ِ
  def to_unicode(239), do: <<217, 143>> # ُ
  def to_unicode(238), do: <<217, 142>> # َ
  def to_unicode(237), do: <<217, 141>> # ٍ
  def to_unicode(236), do: <<217, 140>> # ٌ
  def to_unicode(235), do: <<217, 139>> # ً
  def to_unicode(234), do: <<217, 138>> # ي
  def to_unicode(233), do: <<217, 137>> # ى
  def to_unicode(232), do: <<217, 136>> # و
  def to_unicode(231), do: <<217, 135>> # ه
  def to_unicode(230), do: <<217, 134>> # ن
  def to_unicode(229), do: <<217, 133>> # م
  def to_unicode(228), do: <<217, 132>> # ل
  def to_unicode(227), do: <<217, 131>> # ك
  def to_unicode(226), do: <<217, 130>> # ق
  def to_unicode(225), do: <<217, 129>> # ف
  def to_unicode(224), do: <<217, 128>> # ـ
  def to_unicode(218), do: <<216, 186>> # غ
  def to_unicode(217), do: <<216, 185>> # ع
  def to_unicode(216), do: <<216, 184>> # ظ
  def to_unicode(215), do: <<216, 183>> # ط
