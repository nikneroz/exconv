defmodule Exconv.Mapper.Kz1048 do
  def to_unicode(255), do: <<209, 143>> # я
  ...
  def to_unicode(223), do: <<208, 175>> # Я
  def to_unicode(222), do: <<208, 174>> # Ю
  def to_unicode(221), do: <<208, 173>> # Э
  def to_unicode(220), do: <<208, 172>> # Ь
  def to_unicode(219), do: <<208, 171>> # Ы
  def to_unicode(218), do: <<208, 170>> # Ъ
  def to_unicode(217), do: <<208, 169>> # Щ
  def to_unicode(216), do: <<208, 168>> # Ш
  def to_unicode(215), do: <<208, 167>> # Ч
  def to_unicode(214), do: <<208, 166>> # Ц
  def to_unicode(213), do: <<208, 165>> # Х
  def to_unicode(212), do: <<208, 164>> # Ф
  def to_unicode(211), do: <<208, 163>> # У
  def to_unicode(210), do: <<208, 162>> # Т
  def to_unicode(209), do: <<208, 161>> # С
  def to_unicode(208), do: <<208, 160>> # Р
  def to_unicode(207), do: <<208, 159>> # П
  def to_unicode(206), do: <<208, 158>> # О
  def to_unicode(205), do: <<208, 157>> # Н
  def to_unicode(204), do: <<208, 156>> # М
  def to_unicode(203), do: <<208, 155>> # Л
  def to_unicode(202), do: <<208, 154>> # К
  def to_unicode(201), do: <<208, 153>> # Й
  def to_unicode(200), do: <<208, 152>> # И
  def to_unicode(199), do: <<208, 151>> # З
  def to_unicode(198), do: <<208, 150>> # Ж
  def to_unicode(197), do: <<208, 149>> # Е
  def to_unicode(196), do: <<208, 148>> # Д
  def to_unicode(195), do: <<208, 147>> # Г
  def to_unicode(194), do: <<208, 146>> # В
  def to_unicode(193), do: <<208, 145>> # Б
  def to_unicode(192), do: <<208, 144>> # А
  def to_unicode(191), do: <<210, 175>> # ү
  def to_unicode(190), do: <<210, 163>> # ң
  def to_unicode(189), do: <<210, 162>> # Ң
  def to_unicode(188), do: <<211, 153>> # ә
  def to_unicode(187), do: <<194, 187>> # »
  def to_unicode(186), do: <<210, 147>> # ғ
  def to_unicode(185), do: <<226, 132, 150>> # №
  def to_unicode(184), do: <<209, 145>> # ё
  def to_unicode(183), do: <<194, 183>> # ·
  def to_unicode(182), do: <<194, 182>> # ¶
  def to_unicode(181), do: <<194, 181>> # µ
  def to_unicode(180), do: <<211, 169>> # ө
  def to_unicode(179), do: <<209, 150>> # і
  def to_unicode(178), do: <<208, 134>> # І
  def to_unicode(177), do: <<194, 177>> # ±
  def to_unicode(176), do: <<194, 176>> # °
  def to_unicode(175), do: <<210, 174>> # Ү
  def to_unicode(174), do: <<194, 174>> # ®
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<194, 172>> # ¬
  def to_unicode(171), do: <<194, 171>> # «
  def to_unicode(170), do: <<210, 146>> # Ғ
  def to_unicode(169), do: <<194, 169>> # ©
  def to_unicode(168), do: <<208, 129>> # Ё
  def to_unicode(167), do: <<194, 167>> # §
  def to_unicode(166), do: <<194, 166>> # ¦
  def to_unicode(165), do: <<211, 168>> # Ө
  def to_unicode(164), do: <<194, 164>> # ¤
  def to_unicode(163), do: <<211, 152>> # Ә
  def to_unicode(162), do: <<210, 177>> # ұ
  def to_unicode(161), do: <<210, 176>> # Ұ
  def to_unicode(160), do: <<194, 160>> #  
  def to_unicode(159), do: <<209, 159>> # џ
  def to_unicode(158), do: <<210, 187>> # һ
  def to_unicode(157), do: <<210, 155>> # қ
  def to_unicode(156), do: <<209, 154>> # њ
  def to_unicode(155), do: <<226, 128, 186>> # ›
  def to_unicode(154), do: <<209, 153>> # љ
  ...
  def to_unicode(144), do: <<209, 146>> # ђ
  def to_unicode(143), do: <<208, 143>> # Џ
  def to_unicode(142), do: <<210, 186>> # Һ
  def to_unicode(141), do: <<210, 154>> # Қ
  def to_unicode(140), do: <<208, 138>> # Њ
  def to_unicode(139), do: <<226, 128, 185>> # ‹
  def to_unicode(138), do: <<208, 137>> # Љ
  def to_unicode(137), do: <<226, 128, 176>> # ‰
  def to_unicode(136), do: <<226, 130, 172>> # €
  ...
  def to_unicode(131), do: <<209, 147>> # ѓ
  def to_unicode(130), do: <<226, 128, 154>> # ‚
  def to_unicode(129), do: <<208, 131>> # Ѓ
  def to_unicode(128), do: <<208, 130>> # Ђ
