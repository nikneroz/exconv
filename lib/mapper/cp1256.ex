defmodule Exconv.Mapper.Cp1256 do
  def to_unicode(255), do: <<219, 146>> # ے
  def to_unicode(254), do: <<226, 128, 143>> # ‏
  def to_unicode(253), do: <<226, 128, 142>> # ‎
  def to_unicode(252), do: <<195, 188>> # ü
  def to_unicode(251), do: <<195, 187>> # û
  def to_unicode(250), do: <<217, 146>> # ْ
  def to_unicode(249), do: <<195, 185>> # ù
  def to_unicode(248), do: <<217, 145>> # ّ
  def to_unicode(247), do: <<195, 183>> # ÷
  def to_unicode(246), do: <<217, 144>> # ِ
  def to_unicode(245), do: <<217, 143>> # ُ
  def to_unicode(244), do: <<195, 180>> # ô
  def to_unicode(243), do: <<217, 142>> # َ
  def to_unicode(242), do: <<217, 141>> # ٍ
  def to_unicode(241), do: <<217, 140>> # ٌ
  def to_unicode(240), do: <<217, 139>> # ً
  def to_unicode(239), do: <<195, 175>> # ï
  def to_unicode(238), do: <<195, 174>> # î
  def to_unicode(237), do: <<217, 138>> # ي
  def to_unicode(236), do: <<217, 137>> # ى
  def to_unicode(235), do: <<195, 171>> # ë
  def to_unicode(234), do: <<195, 170>> # ê
  def to_unicode(233), do: <<195, 169>> # é
  def to_unicode(232), do: <<195, 168>> # è
  def to_unicode(231), do: <<195, 167>> # ç
  def to_unicode(230), do: <<217, 136>> # و
  def to_unicode(229), do: <<217, 135>> # ه
  def to_unicode(228), do: <<217, 134>> # ن
  def to_unicode(227), do: <<217, 133>> # م
  def to_unicode(226), do: <<195, 162>> # â
  def to_unicode(225), do: <<217, 132>> # ل
  def to_unicode(224), do: <<195, 160>> # à
  def to_unicode(223), do: <<217, 131>> # ك
  def to_unicode(222), do: <<217, 130>> # ق
  def to_unicode(221), do: <<217, 129>> # ف
  def to_unicode(220), do: <<217, 128>> # ـ
  def to_unicode(219), do: <<216, 186>> # غ
  def to_unicode(218), do: <<216, 185>> # ع
  def to_unicode(217), do: <<216, 184>> # ظ
  def to_unicode(216), do: <<216, 183>> # ط
  def to_unicode(215), do: <<195, 151>> # ×
  def to_unicode(214), do: <<216, 182>> # ض
  def to_unicode(213), do: <<216, 181>> # ص
  def to_unicode(212), do: <<216, 180>> # ش
  def to_unicode(211), do: <<216, 179>> # س
  def to_unicode(210), do: <<216, 178>> # ز
  def to_unicode(209), do: <<216, 177>> # ر
  def to_unicode(208), do: <<216, 176>> # ذ
  def to_unicode(207), do: <<216, 175>> # د
  def to_unicode(206), do: <<216, 174>> # خ
  def to_unicode(205), do: <<216, 173>> # ح
  def to_unicode(204), do: <<216, 172>> # ج
  def to_unicode(203), do: <<216, 171>> # ث
  def to_unicode(202), do: <<216, 170>> # ت
  def to_unicode(201), do: <<216, 169>> # ة
  def to_unicode(200), do: <<216, 168>> # ب
  def to_unicode(199), do: <<216, 167>> # ا
  def to_unicode(198), do: <<216, 166>> # ئ
  def to_unicode(197), do: <<216, 165>> # إ
  def to_unicode(196), do: <<216, 164>> # ؤ
  def to_unicode(195), do: <<216, 163>> # أ
  def to_unicode(194), do: <<216, 162>> # آ
  def to_unicode(193), do: <<216, 161>> # ء
  def to_unicode(192), do: <<219, 129>> # ہ
  ...
  def to_unicode(170), do: <<218, 190>> # ھ
  ...
  def to_unicode(161), do: <<216, 140>> # ،
  def to_unicode(160), do: <<194, 160>> #  
  def to_unicode(159), do: <<218, 186>> # ں
  def to_unicode(158), do: <<226, 128, 141>> # ‍
  def to_unicode(157), do: <<226, 128, 140>> # ‌
  def to_unicode(156), do: <<197, 147>> # œ
  def to_unicode(155), do: <<226, 128, 186>> # ›
  def to_unicode(154), do: <<218, 145>> # ڑ
  def to_unicode(153), do: <<226, 132, 162>> # ™
  def to_unicode(152), do: <<218, 169>> # ک
  ...
  def to_unicode(144), do: <<218, 175>> # گ
  def to_unicode(143), do: <<218, 136>> # ڈ
  def to_unicode(142), do: <<218, 152>> # ژ
  def to_unicode(141), do: <<218, 134>> # چ
  def to_unicode(140), do: <<197, 146>> # Œ
  def to_unicode(139), do: <<226, 128, 185>> # ‹
  def to_unicode(138), do: <<217, 185>> # ٹ
  def to_unicode(137), do: <<226, 128, 176>> # ‰
  def to_unicode(136), do: <<203, 134>> # ˆ
  ...
  def to_unicode(131), do: <<198, 146>> # ƒ
  def to_unicode(130), do: <<226, 128, 154>> # ‚
  def to_unicode(129), do: <<217, 190>> # پ
