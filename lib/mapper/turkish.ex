defmodule Exconv.Mapper.Turkish do
  ...
  def to_unicode(245), do: <<239, 162, 160>> # 
  ...
  def to_unicode(223), do: <<197, 159>> # ş
  def to_unicode(222), do: <<197, 158>> # Ş
  def to_unicode(221), do: <<196, 177>> # ı
  def to_unicode(220), do: <<196, 176>> # İ
  def to_unicode(219), do: <<196, 159>> # ğ
  def to_unicode(218), do: <<196, 158>> # Ğ
