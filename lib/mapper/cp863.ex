defmodule Exconv.Mapper.Cp863 do
  ...
  def to_unicode(173), do: <<194, 190>> # ¾
  def to_unicode(172), do: <<194, 188>> # ¼
  def to_unicode(171), do: <<194, 189>> # ½
  def to_unicode(170), do: <<194, 172>> # ¬
  def to_unicode(169), do: <<226, 140, 144>> # ⌐
  def to_unicode(168), do: <<195, 142>> # Î
  def to_unicode(167), do: <<194, 175>> # ¯
  def to_unicode(166), do: <<194, 179>> # ³
  def to_unicode(165), do: <<194, 184>> # ¸
  def to_unicode(164), do: <<194, 168>> # ¨
  def to_unicode(163), do: <<195, 186>> # ú
  def to_unicode(162), do: <<195, 179>> # ó
  def to_unicode(161), do: <<194, 180>> # ´
  def to_unicode(160), do: <<194, 166>> # ¦
  def to_unicode(159), do: <<198, 146>> # ƒ
  def to_unicode(158), do: <<195, 155>> # Û
  def to_unicode(157), do: <<195, 153>> # Ù
  def to_unicode(156), do: <<194, 163>> # £
  def to_unicode(155), do: <<194, 162>> # ¢
  def to_unicode(154), do: <<195, 156>> # Ü
  def to_unicode(153), do: <<195, 148>> # Ô
  def to_unicode(152), do: <<194, 164>> # ¤
  def to_unicode(151), do: <<195, 185>> # ù
  def to_unicode(150), do: <<195, 187>> # û
  def to_unicode(149), do: <<195, 143>> # Ï
  def to_unicode(148), do: <<195, 139>> # Ë
  def to_unicode(147), do: <<195, 180>> # ô
  def to_unicode(146), do: <<195, 138>> # Ê
  def to_unicode(145), do: <<195, 136>> # È
  def to_unicode(144), do: <<195, 137>> # É
  def to_unicode(143), do: <<194, 167>> # §
  def to_unicode(142), do: <<195, 128>> # À
  def to_unicode(141), do: <<226, 128, 151>> # ‗
  ...
  def to_unicode(134), do: <<194, 182>> # ¶
  def to_unicode(133), do: <<195, 160>> # à
  def to_unicode(132), do: <<195, 130>> # Â
