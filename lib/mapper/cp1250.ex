defmodule Exconv.Mapper.Cp1250 do
  def to_unicode(255), do: <<203, 153>> # ˙
  def to_unicode(254), do: <<197, 163>> # ţ
  def to_unicode(253), do: <<195, 189>> # ý
  def to_unicode(252), do: <<195, 188>> # ü
  def to_unicode(251), do: <<197, 177>> # ű
  def to_unicode(250), do: <<195, 186>> # ú
  def to_unicode(249), do: <<197, 175>> # ů
  def to_unicode(248), do: <<197, 153>> # ř
  def to_unicode(247), do: <<195, 183>> # ÷
  def to_unicode(246), do: <<195, 182>> # ö
  def to_unicode(245), do: <<197, 145>> # ő
  def to_unicode(244), do: <<195, 180>> # ô
  def to_unicode(243), do: <<195, 179>> # ó
  def to_unicode(242), do: <<197, 136>> # ň
  def to_unicode(241), do: <<197, 132>> # ń
  def to_unicode(240), do: <<196, 145>> # đ
  def to_unicode(239), do: <<196, 143>> # ď
  def to_unicode(238), do: <<195, 174>> # î
  def to_unicode(237), do: <<195, 173>> # í
  def to_unicode(236), do: <<196, 155>> # ě
  def to_unicode(235), do: <<195, 171>> # ë
  def to_unicode(234), do: <<196, 153>> # ę
  def to_unicode(233), do: <<195, 169>> # é
  def to_unicode(232), do: <<196, 141>> # č
  def to_unicode(231), do: <<195, 167>> # ç
  def to_unicode(230), do: <<196, 135>> # ć
  def to_unicode(229), do: <<196, 186>> # ĺ
  def to_unicode(228), do: <<195, 164>> # ä
  def to_unicode(227), do: <<196, 131>> # ă
  def to_unicode(226), do: <<195, 162>> # â
  def to_unicode(225), do: <<195, 161>> # á
  def to_unicode(224), do: <<197, 149>> # ŕ
  def to_unicode(223), do: <<195, 159>> # ß
  def to_unicode(222), do: <<197, 162>> # Ţ
  def to_unicode(221), do: <<195, 157>> # Ý
  def to_unicode(220), do: <<195, 156>> # Ü
  def to_unicode(219), do: <<197, 176>> # Ű
  def to_unicode(218), do: <<195, 154>> # Ú
  def to_unicode(217), do: <<197, 174>> # Ů
  def to_unicode(216), do: <<197, 152>> # Ř
  def to_unicode(215), do: <<195, 151>> # ×
  def to_unicode(214), do: <<195, 150>> # Ö
  def to_unicode(213), do: <<197, 144>> # Ő
  def to_unicode(212), do: <<195, 148>> # Ô
  def to_unicode(211), do: <<195, 147>> # Ó
  def to_unicode(210), do: <<197, 135>> # Ň
  def to_unicode(209), do: <<197, 131>> # Ń
  def to_unicode(208), do: <<196, 144>> # Đ
  def to_unicode(207), do: <<196, 142>> # Ď
  def to_unicode(206), do: <<195, 142>> # Î
  def to_unicode(205), do: <<195, 141>> # Í
  def to_unicode(204), do: <<196, 154>> # Ě
  def to_unicode(203), do: <<195, 139>> # Ë
  def to_unicode(202), do: <<196, 152>> # Ę
  def to_unicode(201), do: <<195, 137>> # É
  def to_unicode(200), do: <<196, 140>> # Č
  def to_unicode(199), do: <<195, 135>> # Ç
  def to_unicode(198), do: <<196, 134>> # Ć
  def to_unicode(197), do: <<196, 185>> # Ĺ
  def to_unicode(196), do: <<195, 132>> # Ä
  def to_unicode(195), do: <<196, 130>> # Ă
  def to_unicode(194), do: <<195, 130>> # Â
  def to_unicode(193), do: <<195, 129>> # Á
  def to_unicode(192), do: <<197, 148>> # Ŕ
  def to_unicode(191), do: <<197, 188>> # ż
  def to_unicode(190), do: <<196, 190>> # ľ
  def to_unicode(189), do: <<203, 157>> # ˝
  def to_unicode(188), do: <<196, 189>> # Ľ
  def to_unicode(187), do: <<194, 187>> # »
  def to_unicode(186), do: <<197, 159>> # ş
  def to_unicode(185), do: <<196, 133>> # ą
  ...
  def to_unicode(179), do: <<197, 130>> # ł
  def to_unicode(178), do: <<203, 155>> # ˛
  def to_unicode(177), do: <<194, 177>> # ±
  def to_unicode(176), do: <<194, 176>> # °
  def to_unicode(175), do: <<197, 187>> # Ż
  def to_unicode(174), do: <<194, 174>> # ®
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<194, 172>> # ¬
  def to_unicode(171), do: <<194, 171>> # «
  def to_unicode(170), do: <<197, 158>> # Ş
  def to_unicode(169), do: <<194, 169>> # ©
  def to_unicode(168), do: <<194, 168>> # ¨
  def to_unicode(167), do: <<194, 167>> # §
  def to_unicode(166), do: <<194, 166>> # ¦
  def to_unicode(165), do: <<196, 132>> # Ą
  def to_unicode(164), do: <<194, 164>> # ¤
  def to_unicode(163), do: <<197, 129>> # Ł
  def to_unicode(162), do: <<203, 152>> # ˘
  def to_unicode(161), do: <<203, 135>> # ˇ
  def to_unicode(160), do: <<194, 160>> #  
  def to_unicode(159), do: <<197, 186>> # ź
  def to_unicode(158), do: <<197, 190>> # ž
  def to_unicode(157), do: <<197, 165>> # ť
  def to_unicode(156), do: <<197, 155>> # ś
  def to_unicode(155), do: <<226, 128, 186>> # ›
  def to_unicode(154), do: <<197, 161>> # š
  def to_unicode(153), do: <<226, 132, 162>> # ™
  ...
  def to_unicode(142), do: <<197, 189>> # Ž
  def to_unicode(141), do: <<197, 164>> # Ť
  def to_unicode(140), do: <<197, 154>> # Ś
  def to_unicode(139), do: <<226, 128, 185>> # ‹
  def to_unicode(138), do: <<197, 160>> # Š
  def to_unicode(137), do: <<226, 128, 176>> # ‰
  def to_unicode(136), do: <<194, 152>> # 
  def to_unicode(135), do: <<226, 128, 161>> # ‡
  def to_unicode(134), do: <<226, 128, 160>> # †
  def to_unicode(133), do: <<226, 128, 166>> # …
  def to_unicode(132), do: <<226, 128, 158>> # „
  def to_unicode(131), do: <<194, 152>> # 
  def to_unicode(130), do: <<226, 128, 154>> # ‚
