defmodule Exconv.Mapper.Iso8859_3 do
  def to_unicode(255), do: <<203, 153>> # ˙
  def to_unicode(254), do: <<197, 157>> # ŝ
  def to_unicode(253), do: <<197, 173>> # ŭ
  ...
  def to_unicode(248), do: <<196, 157>> # ĝ
  def to_unicode(247), do: <<195, 183>> # ÷
  def to_unicode(246), do: <<195, 182>> # ö
  def to_unicode(245), do: <<196, 161>> # ġ
  ...
  def to_unicode(230), do: <<196, 137>> # ĉ
  def to_unicode(229), do: <<196, 139>> # ċ
  ...
  def to_unicode(222), do: <<197, 156>> # Ŝ
  def to_unicode(221), do: <<197, 172>> # Ŭ
  ...
  def to_unicode(216), do: <<196, 156>> # Ĝ
  def to_unicode(215), do: <<195, 151>> # ×
  def to_unicode(214), do: <<195, 150>> # Ö
  def to_unicode(213), do: <<196, 160>> # Ġ
  ...
  def to_unicode(198), do: <<196, 136>> # Ĉ
  def to_unicode(197), do: <<196, 138>> # Ċ
