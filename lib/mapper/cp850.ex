defmodule Exconv.Mapper.Cp850 do
  ...
  def to_unicode(232), do: <<195, 158>> # Þ
  def to_unicode(231), do: <<195, 190>> # þ
  ...
  def to_unicode(213), do: <<196, 177>> # ı
  def to_unicode(212), do: <<195, 136>> # È
  def to_unicode(211), do: <<195, 139>> # Ë
  def to_unicode(210), do: <<195, 138>> # Ê
  def to_unicode(209), do: <<195, 144>> # Ð
  def to_unicode(208), do: <<195, 176>> # ð
  ...
  def to_unicode(159), do: <<198, 146>> # ƒ
  ...
  def to_unicode(152), do: <<195, 191>> # ÿ
