defmodule Exconv.Mapper.Cp775 do
  ...
  def to_unicode(247), do: <<226, 128, 158>> # „
  def to_unicode(246), do: <<195, 183>> # ÷
  def to_unicode(245), do: <<194, 167>> # §
  def to_unicode(244), do: <<194, 182>> # ¶
  def to_unicode(243), do: <<194, 190>> # ¾
  def to_unicode(242), do: <<226, 128, 156>> # “
  def to_unicode(241), do: <<194, 177>> # ±
  def to_unicode(240), do: <<194, 173>> # ­
  def to_unicode(239), do: <<226, 128, 153>> # ’
  def to_unicode(238), do: <<197, 133>> # Ņ
  def to_unicode(237), do: <<196, 146>> # Ē
  def to_unicode(236), do: <<197, 134>> # ņ
  def to_unicode(235), do: <<196, 188>> # ļ
  def to_unicode(234), do: <<196, 187>> # Ļ
  def to_unicode(233), do: <<196, 183>> # ķ
  def to_unicode(232), do: <<196, 182>> # Ķ
  def to_unicode(231), do: <<197, 132>> # ń
  def to_unicode(230), do: <<194, 181>> # µ
  def to_unicode(229), do: <<195, 149>> # Õ
  def to_unicode(228), do: <<195, 181>> # õ
  def to_unicode(227), do: <<197, 131>> # Ń
  def to_unicode(226), do: <<197, 140>> # Ō
  ...
  def to_unicode(216), do: <<197, 190>> # ž
  def to_unicode(215), do: <<197, 171>> # ū
  def to_unicode(214), do: <<197, 179>> # ų
  def to_unicode(213), do: <<197, 161>> # š
  def to_unicode(212), do: <<196, 175>> # į
  def to_unicode(211), do: <<196, 151>> # ė
  def to_unicode(210), do: <<196, 153>> # ę
  def to_unicode(209), do: <<196, 141>> # č
  def to_unicode(208), do: <<196, 133>> # ą
  def to_unicode(207), do: <<197, 189>> # Ž
  ...
  def to_unicode(199), do: <<197, 170>> # Ū
  def to_unicode(198), do: <<197, 178>> # Ų
  ...
  def to_unicode(190), do: <<197, 160>> # Š
  def to_unicode(189), do: <<196, 174>> # Į
  ...
  def to_unicode(184), do: <<196, 150>> # Ė
  def to_unicode(183), do: <<196, 152>> # Ę
  def to_unicode(182), do: <<196, 140>> # Č
  def to_unicode(181), do: <<196, 132>> # Ą
  ...
  def to_unicode(173), do: <<197, 129>> # Ł
  def to_unicode(172), do: <<194, 188>> # ¼
  def to_unicode(171), do: <<194, 189>> # ½
  def to_unicode(170), do: <<194, 172>> # ¬
  def to_unicode(169), do: <<194, 174>> # ®
  def to_unicode(168), do: <<194, 169>> # ©
  def to_unicode(167), do: <<194, 166>> # ¦
  def to_unicode(166), do: <<226, 128, 157>> # ”
  def to_unicode(165), do: <<197, 186>> # ź
  def to_unicode(164), do: <<197, 188>> # ż
  def to_unicode(163), do: <<197, 187>> # Ż
  def to_unicode(162), do: <<195, 179>> # ó
  def to_unicode(161), do: <<196, 170>> # Ī
  def to_unicode(160), do: <<196, 128>> # Ā
  def to_unicode(159), do: <<194, 164>> # ¤
  def to_unicode(158), do: <<195, 151>> # ×
  def to_unicode(157), do: <<195, 152>> # Ø
  def to_unicode(156), do: <<194, 163>> # £
  def to_unicode(155), do: <<195, 184>> # ø
  ...
  def to_unicode(150), do: <<194, 162>> # ¢
  def to_unicode(149), do: <<196, 162>> # Ģ
  def to_unicode(148), do: <<195, 182>> # ö
  def to_unicode(147), do: <<197, 141>> # ō
  def to_unicode(146), do: <<195, 134>> # Æ
  def to_unicode(145), do: <<195, 166>> # æ
  def to_unicode(144), do: <<195, 137>> # É
  def to_unicode(143), do: <<195, 133>> # Å
  def to_unicode(142), do: <<195, 132>> # Ä
  def to_unicode(141), do: <<197, 185>> # Ź
  def to_unicode(140), do: <<196, 171>> # ī
  def to_unicode(139), do: <<197, 151>> # ŗ
  def to_unicode(138), do: <<197, 150>> # Ŗ
  def to_unicode(137), do: <<196, 147>> # ē
  def to_unicode(136), do: <<197, 130>> # ł
  def to_unicode(135), do: <<196, 135>> # ć
  def to_unicode(134), do: <<195, 165>> # å
  def to_unicode(133), do: <<196, 163>> # ģ
  def to_unicode(132), do: <<195, 164>> # ä
  def to_unicode(131), do: <<196, 129>> # ā
  def to_unicode(130), do: <<195, 169>> # é
  def to_unicode(129), do: <<195, 188>> # ü
  def to_unicode(128), do: <<196, 134>> # Ć
