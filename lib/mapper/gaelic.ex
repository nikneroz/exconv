defmodule Exconv.Mapper.Gaelic do
  def to_unicode(255), do: <<225, 186, 131>> # ẃ
  def to_unicode(254), do: <<225, 186, 130>> # Ẃ
  def to_unicode(253), do: <<225, 186, 129>> # ẁ
  def to_unicode(252), do: <<225, 186, 128>> # Ẁ
  def to_unicode(251), do: <<225, 186, 133>> # ẅ
  def to_unicode(250), do: <<225, 186, 132>> # Ẅ
  def to_unicode(249), do: <<197, 181>> # ŵ
  def to_unicode(248), do: <<197, 180>> # Ŵ
  def to_unicode(247), do: <<195, 189>> # ý
  def to_unicode(246), do: <<195, 157>> # Ý
  ...
  def to_unicode(240), do: <<226, 153, 163>> # ♣
  ...
  def to_unicode(228), do: <<226, 129, 138>> # ⁊
  def to_unicode(227), do: <<225, 187, 179>> # ỳ
  def to_unicode(226), do: <<225, 187, 178>> # Ỳ
  def to_unicode(225), do: <<194, 183>> # ·
  def to_unicode(224), do: <<225, 185, 171>> # ṫ
  def to_unicode(223), do: <<197, 183>> # ŷ
  ...
  def to_unicode(218), do: <<225, 185, 170>> # Ṫ
  def to_unicode(217), do: <<197, 184>> # Ÿ
  def to_unicode(216), do: <<195, 191>> # ÿ
  def to_unicode(215), do: <<225, 186, 155>> # ẛ
  def to_unicode(214), do: <<225, 185, 161>> # ṡ
  ...
  def to_unicode(198), do: <<225, 185, 160>> # Ṡ
  def to_unicode(197), do: <<197, 191>> # ſ
  def to_unicode(196), do: <<198, 146>> # ƒ
  def to_unicode(195), do: <<201, 188>> # ɼ
  def to_unicode(194), do: <<225, 185, 151>> # ṗ
  def to_unicode(193), do: <<225, 185, 150>> # Ṗ
  def to_unicode(192), do: <<225, 185, 129>> # ṁ
  def to_unicode(191), do: <<195, 184>> # ø
  def to_unicode(190), do: <<195, 166>> # æ
  def to_unicode(189), do: <<225, 185, 128>> # Ṁ
  def to_unicode(188), do: <<196, 161>> # ġ
  def to_unicode(187), do: <<196, 160>> # Ġ
  def to_unicode(186), do: <<225, 184, 159>> # ḟ
  def to_unicode(185), do: <<225, 184, 158>> # Ḟ
  def to_unicode(184), do: <<225, 184, 139>> # ḋ
  def to_unicode(183), do: <<225, 184, 138>> # Ḋ
  def to_unicode(182), do: <<196, 139>> # ċ
  def to_unicode(181), do: <<196, 138>> # Ċ
  def to_unicode(180), do: <<225, 184, 131>> # ḃ
  def to_unicode(179), do: <<226, 137, 165>> # ≥
  def to_unicode(178), do: <<226, 137, 164>> # ≤
  def to_unicode(177), do: <<194, 177>> # ±
  def to_unicode(176), do: <<225, 184, 130>> # Ḃ
  def to_unicode(175), do: <<195, 152>> # Ø
  def to_unicode(174), do: <<195, 134>> # Æ
