defmodule Exconv.Mapper.Cp861 do
  ...
  def to_unicode(167), do: <<195, 154>> # Ú
  def to_unicode(166), do: <<195, 147>> # Ó
  def to_unicode(165), do: <<195, 141>> # Í
  def to_unicode(164), do: <<195, 129>> # Á
  ...
  def to_unicode(152), do: <<195, 189>> # ý
  def to_unicode(151), do: <<195, 157>> # Ý
  def to_unicode(150), do: <<195, 187>> # û
  def to_unicode(149), do: <<195, 190>> # þ
  ...
  def to_unicode(141), do: <<195, 158>> # Þ
  def to_unicode(140), do: <<195, 176>> # ð
  def to_unicode(139), do: <<195, 144>> # Ð
