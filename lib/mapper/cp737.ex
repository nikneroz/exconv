defmodule Exconv.Mapper.Cp737 do
  ...
  def to_unicode(245), do: <<206, 171>> # Ϋ
  def to_unicode(244), do: <<206, 170>> # Ϊ
  def to_unicode(243), do: <<226, 137, 164>> # ≤
  def to_unicode(242), do: <<226, 137, 165>> # ≥
  def to_unicode(241), do: <<194, 177>> # ±
  def to_unicode(240), do: <<206, 143>> # Ώ
  def to_unicode(239), do: <<206, 142>> # Ύ
  def to_unicode(238), do: <<206, 140>> # Ό
  def to_unicode(237), do: <<206, 138>> # Ί
  def to_unicode(236), do: <<206, 137>> # Ή
  def to_unicode(235), do: <<206, 136>> # Έ
  def to_unicode(234), do: <<206, 134>> # Ά
  def to_unicode(233), do: <<207, 142>> # ώ
  def to_unicode(232), do: <<207, 139>> # ϋ
  def to_unicode(231), do: <<207, 141>> # ύ
  def to_unicode(230), do: <<207, 140>> # ό
  def to_unicode(229), do: <<206, 175>> # ί
  def to_unicode(228), do: <<207, 138>> # ϊ
  def to_unicode(227), do: <<206, 174>> # ή
  def to_unicode(226), do: <<206, 173>> # έ
  def to_unicode(225), do: <<206, 172>> # ά
  def to_unicode(224), do: <<207, 137>> # ω
  ...
  def to_unicode(175), do: <<207, 136>> # ψ
  def to_unicode(174), do: <<207, 135>> # χ
  def to_unicode(173), do: <<207, 134>> # φ
  def to_unicode(172), do: <<207, 133>> # υ
  def to_unicode(171), do: <<207, 132>> # τ
  def to_unicode(170), do: <<207, 130>> # ς
  def to_unicode(169), do: <<207, 131>> # σ
  def to_unicode(168), do: <<207, 129>> # ρ
  def to_unicode(167), do: <<207, 128>> # π
  def to_unicode(166), do: <<206, 191>> # ο
  def to_unicode(165), do: <<206, 190>> # ξ
  def to_unicode(164), do: <<206, 189>> # ν
  def to_unicode(163), do: <<206, 188>> # μ
  def to_unicode(162), do: <<206, 187>> # λ
  def to_unicode(161), do: <<206, 186>> # κ
  def to_unicode(160), do: <<206, 185>> # ι
  def to_unicode(159), do: <<206, 184>> # θ
  def to_unicode(158), do: <<206, 183>> # η
  def to_unicode(157), do: <<206, 182>> # ζ
  def to_unicode(156), do: <<206, 181>> # ε
  def to_unicode(155), do: <<206, 180>> # δ
  def to_unicode(154), do: <<206, 179>> # γ
  def to_unicode(153), do: <<206, 178>> # β
  def to_unicode(152), do: <<206, 177>> # α
  def to_unicode(151), do: <<206, 169>> # Ω
  def to_unicode(150), do: <<206, 168>> # Ψ
  def to_unicode(149), do: <<206, 167>> # Χ
  def to_unicode(148), do: <<206, 166>> # Φ
  def to_unicode(147), do: <<206, 165>> # Υ
  def to_unicode(146), do: <<206, 164>> # Τ
  def to_unicode(145), do: <<206, 163>> # Σ
  def to_unicode(144), do: <<206, 161>> # Ρ
  def to_unicode(143), do: <<206, 160>> # Π
  def to_unicode(142), do: <<206, 159>> # Ο
  def to_unicode(141), do: <<206, 158>> # Ξ
  def to_unicode(140), do: <<206, 157>> # Ν
  def to_unicode(139), do: <<206, 156>> # Μ
  def to_unicode(138), do: <<206, 155>> # Λ
  def to_unicode(137), do: <<206, 154>> # Κ
  def to_unicode(136), do: <<206, 153>> # Ι
  def to_unicode(135), do: <<206, 152>> # Θ
  def to_unicode(134), do: <<206, 151>> # Η
  def to_unicode(133), do: <<206, 150>> # Ζ
  def to_unicode(132), do: <<206, 149>> # Ε
  def to_unicode(131), do: <<206, 148>> # Δ
  def to_unicode(130), do: <<206, 147>> # Γ
  def to_unicode(129), do: <<206, 146>> # Β
  def to_unicode(128), do: <<206, 145>> # Α
