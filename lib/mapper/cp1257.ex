defmodule Exconv.Mapper.Cp1257 do
  ...
  def to_unicode(254), do: <<197, 190>> # ž
  def to_unicode(253), do: <<197, 188>> # ż
  def to_unicode(252), do: <<195, 188>> # ü
  def to_unicode(251), do: <<197, 171>> # ū
  def to_unicode(250), do: <<197, 155>> # ś
  def to_unicode(249), do: <<197, 130>> # ł
  def to_unicode(248), do: <<197, 179>> # ų
  def to_unicode(247), do: <<195, 183>> # ÷
  def to_unicode(246), do: <<195, 182>> # ö
  def to_unicode(245), do: <<195, 181>> # õ
  def to_unicode(244), do: <<197, 141>> # ō
  def to_unicode(243), do: <<195, 179>> # ó
  def to_unicode(242), do: <<197, 134>> # ņ
  def to_unicode(241), do: <<197, 132>> # ń
  def to_unicode(240), do: <<197, 161>> # š
  def to_unicode(239), do: <<196, 188>> # ļ
  def to_unicode(238), do: <<196, 171>> # ī
  def to_unicode(237), do: <<196, 183>> # ķ
  def to_unicode(236), do: <<196, 163>> # ģ
  def to_unicode(235), do: <<196, 151>> # ė
  def to_unicode(234), do: <<197, 186>> # ź
  def to_unicode(233), do: <<195, 169>> # é
  def to_unicode(232), do: <<196, 141>> # č
  def to_unicode(231), do: <<196, 147>> # ē
  def to_unicode(230), do: <<196, 153>> # ę
  def to_unicode(229), do: <<195, 165>> # å
  def to_unicode(228), do: <<195, 164>> # ä
  def to_unicode(227), do: <<196, 135>> # ć
  def to_unicode(226), do: <<196, 129>> # ā
  def to_unicode(225), do: <<196, 175>> # į
  def to_unicode(224), do: <<196, 133>> # ą
  def to_unicode(223), do: <<195, 159>> # ß
  def to_unicode(222), do: <<197, 189>> # Ž
  def to_unicode(221), do: <<197, 187>> # Ż
  def to_unicode(220), do: <<195, 156>> # Ü
  def to_unicode(219), do: <<197, 170>> # Ū
  def to_unicode(218), do: <<197, 154>> # Ś
  def to_unicode(217), do: <<197, 129>> # Ł
  def to_unicode(216), do: <<197, 178>> # Ų
  def to_unicode(215), do: <<195, 151>> # ×
  def to_unicode(214), do: <<195, 150>> # Ö
  def to_unicode(213), do: <<195, 149>> # Õ
  def to_unicode(212), do: <<197, 140>> # Ō
  def to_unicode(211), do: <<195, 147>> # Ó
  def to_unicode(210), do: <<197, 133>> # Ņ
  def to_unicode(209), do: <<197, 131>> # Ń
  def to_unicode(208), do: <<197, 160>> # Š
  def to_unicode(207), do: <<196, 187>> # Ļ
  def to_unicode(206), do: <<196, 170>> # Ī
  def to_unicode(205), do: <<196, 182>> # Ķ
  def to_unicode(204), do: <<196, 162>> # Ģ
  def to_unicode(203), do: <<196, 150>> # Ė
  def to_unicode(202), do: <<197, 185>> # Ź
  def to_unicode(201), do: <<195, 137>> # É
  def to_unicode(200), do: <<196, 140>> # Č
  def to_unicode(199), do: <<196, 146>> # Ē
  def to_unicode(198), do: <<196, 152>> # Ę
  def to_unicode(197), do: <<195, 133>> # Å
  def to_unicode(196), do: <<195, 132>> # Ä
  def to_unicode(195), do: <<196, 134>> # Ć
  def to_unicode(194), do: <<196, 128>> # Ā
  def to_unicode(193), do: <<196, 174>> # Į
  def to_unicode(192), do: <<196, 132>> # Ą
  def to_unicode(191), do: <<195, 166>> # æ
  def to_unicode(190), do: <<194, 190>> # ¾
  def to_unicode(189), do: <<194, 189>> # ½
  def to_unicode(188), do: <<194, 188>> # ¼
  def to_unicode(187), do: <<194, 187>> # »
  def to_unicode(186), do: <<197, 151>> # ŗ
  def to_unicode(185), do: <<194, 185>> # ¹
  def to_unicode(184), do: <<195, 184>> # ø
  ...
  def to_unicode(143), do: <<194, 184>> # ¸
  def to_unicode(142), do: <<203, 135>> # ˇ
  def to_unicode(141), do: <<194, 168>> # ¨
