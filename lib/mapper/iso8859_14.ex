defmodule Exconv.Mapper.Iso8859_14 do
  def to_unicode(255), do: <<195, 191>> # ÿ
  def to_unicode(254), do: <<197, 183>> # ŷ
  ...
  def to_unicode(247), do: <<225, 185, 171>> # ṫ
  ...
  def to_unicode(240), do: <<197, 181>> # ŵ
  ...
  def to_unicode(222), do: <<197, 182>> # Ŷ
  ...
  def to_unicode(215), do: <<225, 185, 170>> # Ṫ
  ...
  def to_unicode(208), do: <<197, 180>> # Ŵ
  ...
  def to_unicode(191), do: <<225, 185, 161>> # ṡ
  def to_unicode(190), do: <<225, 186, 133>> # ẅ
  def to_unicode(189), do: <<225, 186, 132>> # Ẅ
  def to_unicode(188), do: <<225, 187, 179>> # ỳ
  def to_unicode(187), do: <<225, 185, 160>> # Ṡ
  def to_unicode(186), do: <<225, 186, 131>> # ẃ
  def to_unicode(185), do: <<225, 185, 151>> # ṗ
  def to_unicode(184), do: <<225, 186, 129>> # ẁ
  def to_unicode(183), do: <<225, 185, 150>> # Ṗ
  def to_unicode(182), do: <<194, 182>> # ¶
  def to_unicode(181), do: <<225, 185, 129>> # ṁ
  def to_unicode(180), do: <<225, 185, 128>> # Ṁ
  def to_unicode(179), do: <<196, 161>> # ġ
  def to_unicode(178), do: <<196, 160>> # Ġ
  def to_unicode(177), do: <<225, 184, 159>> # ḟ
  def to_unicode(176), do: <<225, 184, 158>> # Ḟ
  def to_unicode(175), do: <<197, 184>> # Ÿ
  def to_unicode(174), do: <<194, 174>> # ®
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<225, 187, 178>> # Ỳ
  def to_unicode(171), do: <<225, 184, 139>> # ḋ
  def to_unicode(170), do: <<225, 186, 130>> # Ẃ
  def to_unicode(169), do: <<194, 169>> # ©
  def to_unicode(168), do: <<225, 186, 128>> # Ẁ
  def to_unicode(167), do: <<194, 167>> # §
  def to_unicode(166), do: <<225, 184, 138>> # Ḋ
  def to_unicode(165), do: <<196, 139>> # ċ
  def to_unicode(164), do: <<196, 138>> # Ċ
  def to_unicode(163), do: <<194, 163>> # £
  def to_unicode(162), do: <<225, 184, 131>> # ḃ
  def to_unicode(161), do: <<225, 184, 130>> # Ḃ
