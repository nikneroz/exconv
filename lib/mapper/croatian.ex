defmodule Exconv.Mapper.Croatian do
  def to_unicode(255), do: <<203, 135>> # ˇ
  def to_unicode(254), do: <<195, 166>> # æ
  def to_unicode(253), do: <<195, 138>> # Ê
  def to_unicode(252), do: <<194, 184>> # ¸
  def to_unicode(251), do: <<203, 154>> # ˚
  def to_unicode(250), do: <<195, 139>> # Ë
  def to_unicode(249), do: <<207, 128>> # π
  ...
  def to_unicode(224), do: <<226, 128, 147>> # –
  def to_unicode(223), do: <<194, 187>> # »
  def to_unicode(222), do: <<195, 134>> # Æ
  ...
  def to_unicode(217), do: <<194, 169>> # ©
  def to_unicode(216), do: <<239, 163, 191>> # 
  ...
  def to_unicode(180), do: <<226, 136, 134>> # ∆
