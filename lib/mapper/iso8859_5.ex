defmodule Exconv.Mapper.Iso8859_5 do
  def to_unicode(255), do: <<209, 159>> # џ
  def to_unicode(254), do: <<209, 158>> # ў
  def to_unicode(253), do: <<194, 167>> # §
  def to_unicode(252), do: <<209, 156>> # ќ
  def to_unicode(251), do: <<209, 155>> # ћ
  def to_unicode(250), do: <<209, 154>> # њ
  def to_unicode(249), do: <<209, 153>> # љ
  def to_unicode(248), do: <<209, 152>> # ј
  def to_unicode(247), do: <<209, 151>> # ї
  def to_unicode(246), do: <<209, 150>> # і
  def to_unicode(245), do: <<209, 149>> # ѕ
  def to_unicode(244), do: <<209, 148>> # є
  def to_unicode(243), do: <<209, 147>> # ѓ
  def to_unicode(242), do: <<209, 146>> # ђ
  def to_unicode(241), do: <<209, 145>> # ё
  def to_unicode(240), do: <<226, 132, 150>> # №
  ...
  def to_unicode(223), do: <<208, 191>> # п
  def to_unicode(222), do: <<208, 190>> # о
  def to_unicode(221), do: <<208, 189>> # н
  def to_unicode(220), do: <<208, 188>> # м
  def to_unicode(219), do: <<208, 187>> # л
  def to_unicode(218), do: <<208, 186>> # к
  def to_unicode(217), do: <<208, 185>> # й
  def to_unicode(216), do: <<208, 184>> # и
  def to_unicode(215), do: <<208, 183>> # з
  def to_unicode(214), do: <<208, 182>> # ж
  def to_unicode(213), do: <<208, 181>> # е
  def to_unicode(212), do: <<208, 180>> # д
  def to_unicode(211), do: <<208, 179>> # г
  def to_unicode(210), do: <<208, 178>> # в
  def to_unicode(209), do: <<208, 177>> # б
  def to_unicode(208), do: <<208, 176>> # а
  def to_unicode(207), do: <<208, 175>> # Я
  def to_unicode(206), do: <<208, 174>> # Ю
  def to_unicode(205), do: <<208, 173>> # Э
  def to_unicode(204), do: <<208, 172>> # Ь
  def to_unicode(203), do: <<208, 171>> # Ы
  def to_unicode(202), do: <<208, 170>> # Ъ
  def to_unicode(201), do: <<208, 169>> # Щ
  def to_unicode(200), do: <<208, 168>> # Ш
  def to_unicode(199), do: <<208, 167>> # Ч
  def to_unicode(198), do: <<208, 166>> # Ц
  def to_unicode(197), do: <<208, 165>> # Х
  def to_unicode(196), do: <<208, 164>> # Ф
  def to_unicode(195), do: <<208, 163>> # У
  def to_unicode(194), do: <<208, 162>> # Т
  def to_unicode(193), do: <<208, 161>> # С
  def to_unicode(192), do: <<208, 160>> # Р
  def to_unicode(191), do: <<208, 159>> # П
  def to_unicode(190), do: <<208, 158>> # О
  def to_unicode(189), do: <<208, 157>> # Н
  def to_unicode(188), do: <<208, 156>> # М
  def to_unicode(187), do: <<208, 155>> # Л
  def to_unicode(186), do: <<208, 154>> # К
  def to_unicode(185), do: <<208, 153>> # Й
  def to_unicode(184), do: <<208, 152>> # И
  def to_unicode(183), do: <<208, 151>> # З
  def to_unicode(182), do: <<208, 150>> # Ж
  def to_unicode(181), do: <<208, 149>> # Е
  def to_unicode(180), do: <<208, 148>> # Д
  def to_unicode(179), do: <<208, 147>> # Г
  def to_unicode(178), do: <<208, 146>> # В
  def to_unicode(177), do: <<208, 145>> # Б
  def to_unicode(176), do: <<208, 144>> # А
  def to_unicode(175), do: <<208, 143>> # Џ
  def to_unicode(174), do: <<208, 142>> # Ў
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<208, 140>> # Ќ
  def to_unicode(171), do: <<208, 139>> # Ћ
  def to_unicode(170), do: <<208, 138>> # Њ
  def to_unicode(169), do: <<208, 137>> # Љ
  def to_unicode(168), do: <<208, 136>> # Ј
  def to_unicode(167), do: <<208, 135>> # Ї
  def to_unicode(166), do: <<208, 134>> # І
  def to_unicode(165), do: <<208, 133>> # Ѕ
  def to_unicode(164), do: <<208, 132>> # Є
  def to_unicode(163), do: <<208, 131>> # Ѓ
  def to_unicode(162), do: <<208, 130>> # Ђ
  def to_unicode(161), do: <<208, 129>> # Ё
