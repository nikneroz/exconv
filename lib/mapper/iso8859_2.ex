defmodule Exconv.Mapper.Iso8859_2 do
  ...
  def to_unicode(190), do: <<197, 190>> # ž
  def to_unicode(189), do: <<203, 157>> # ˝
  def to_unicode(188), do: <<197, 186>> # ź
  def to_unicode(187), do: <<197, 165>> # ť
  def to_unicode(186), do: <<197, 159>> # ş
  def to_unicode(185), do: <<197, 161>> # š
  def to_unicode(184), do: <<194, 184>> # ¸
  def to_unicode(183), do: <<203, 135>> # ˇ
  def to_unicode(182), do: <<197, 155>> # ś
  def to_unicode(181), do: <<196, 190>> # ľ
  ...
  def to_unicode(174), do: <<197, 189>> # Ž
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<197, 185>> # Ź
  def to_unicode(171), do: <<197, 164>> # Ť
  def to_unicode(170), do: <<197, 158>> # Ş
  def to_unicode(169), do: <<197, 160>> # Š
  def to_unicode(168), do: <<194, 168>> # ¨
  def to_unicode(167), do: <<194, 167>> # §
  def to_unicode(166), do: <<197, 154>> # Ś
  def to_unicode(165), do: <<196, 189>> # Ľ
