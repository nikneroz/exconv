defmodule Exconv.Mapper.Cp1251 do
  ...
  def to_unicode(191), do: <<209, 151>> # ї
  def to_unicode(190), do: <<209, 149>> # ѕ
  def to_unicode(189), do: <<208, 133>> # Ѕ
  def to_unicode(188), do: <<209, 152>> # ј
  def to_unicode(187), do: <<194, 187>> # »
  def to_unicode(186), do: <<209, 148>> # є
  ...
  def to_unicode(142), do: <<208, 139>> # Ћ
  def to_unicode(141), do: <<208, 140>> # Ќ
