defmodule Exconv.Mapper.Cp852 do
  def to_unicode(255), do: <<194, 160>> #  
  def to_unicode(254), do: <<226, 150, 160>> # ■
  def to_unicode(253), do: <<197, 153>> # ř
  def to_unicode(252), do: <<197, 152>> # Ř
  ...
  def to_unicode(244), do: <<203, 152>> # ˘
  def to_unicode(243), do: <<203, 135>> # ˇ
  def to_unicode(242), do: <<203, 155>> # ˛
  def to_unicode(241), do: <<203, 157>> # ˝
  def to_unicode(240), do: <<194, 173>> # ­
  def to_unicode(239), do: <<194, 180>> # ´
  def to_unicode(238), do: <<197, 163>> # ţ
  def to_unicode(237), do: <<195, 157>> # Ý
  def to_unicode(236), do: <<195, 189>> # ý
  def to_unicode(235), do: <<197, 176>> # Ű
  def to_unicode(234), do: <<197, 149>> # ŕ
  def to_unicode(233), do: <<195, 154>> # Ú
  def to_unicode(232), do: <<197, 148>> # Ŕ
  def to_unicode(231), do: <<197, 161>> # š
  def to_unicode(230), do: <<197, 160>> # Š
  def to_unicode(229), do: <<197, 136>> # ň
  def to_unicode(228), do: <<197, 132>> # ń
  def to_unicode(227), do: <<197, 131>> # Ń
  def to_unicode(226), do: <<195, 148>> # Ô
  def to_unicode(225), do: <<195, 159>> # ß
  def to_unicode(224), do: <<195, 147>> # Ó
  def to_unicode(223), do: <<226, 150, 128>> # ▀
  def to_unicode(222), do: <<197, 174>> # Ů
  def to_unicode(221), do: <<197, 162>> # Ţ
  ...
  def to_unicode(216), do: <<196, 155>> # ě
  def to_unicode(215), do: <<195, 142>> # Î
  def to_unicode(214), do: <<195, 141>> # Í
  def to_unicode(213), do: <<197, 135>> # Ň
  def to_unicode(212), do: <<196, 143>> # ď
  def to_unicode(211), do: <<195, 139>> # Ë
  def to_unicode(210), do: <<196, 142>> # Ď
  def to_unicode(209), do: <<196, 144>> # Đ
  def to_unicode(208), do: <<196, 145>> # đ
  ...
  def to_unicode(199), do: <<196, 131>> # ă
  def to_unicode(198), do: <<196, 130>> # Ă
  ...
  def to_unicode(190), do: <<197, 188>> # ż
  def to_unicode(189), do: <<197, 187>> # Ż
  ...
  def to_unicode(184), do: <<197, 158>> # Ş
  def to_unicode(183), do: <<196, 154>> # Ě
  def to_unicode(182), do: <<195, 130>> # Â
  def to_unicode(181), do: <<195, 129>> # Á
  ...
  def to_unicode(173), do: <<197, 159>> # ş
  def to_unicode(172), do: <<196, 140>> # Č
  def to_unicode(171), do: <<197, 186>> # ź
  def to_unicode(170), do: <<194, 172>> # ¬
  def to_unicode(169), do: <<196, 153>> # ę
  def to_unicode(168), do: <<196, 152>> # Ę
  def to_unicode(167), do: <<197, 190>> # ž
  def to_unicode(166), do: <<197, 189>> # Ž
  def to_unicode(165), do: <<196, 133>> # ą
  def to_unicode(164), do: <<196, 132>> # Ą
  ...
  def to_unicode(159), do: <<196, 141>> # č
  def to_unicode(158), do: <<195, 151>> # ×
  def to_unicode(157), do: <<197, 129>> # Ł
  def to_unicode(156), do: <<197, 165>> # ť
  def to_unicode(155), do: <<197, 164>> # Ť
  def to_unicode(154), do: <<195, 156>> # Ü
  def to_unicode(153), do: <<195, 150>> # Ö
  def to_unicode(152), do: <<197, 155>> # ś
  def to_unicode(151), do: <<197, 154>> # Ś
  def to_unicode(150), do: <<196, 190>> # ľ
  def to_unicode(149), do: <<196, 189>> # Ľ
  def to_unicode(148), do: <<195, 182>> # ö
  def to_unicode(147), do: <<195, 180>> # ô
  def to_unicode(146), do: <<196, 186>> # ĺ
  def to_unicode(145), do: <<196, 185>> # Ĺ
  def to_unicode(144), do: <<195, 137>> # É
  def to_unicode(143), do: <<196, 134>> # Ć
  def to_unicode(142), do: <<195, 132>> # Ä
  def to_unicode(141), do: <<197, 185>> # Ź
  def to_unicode(140), do: <<195, 174>> # î
  def to_unicode(139), do: <<197, 145>> # ő
  def to_unicode(138), do: <<197, 144>> # Ő
  def to_unicode(137), do: <<195, 171>> # ë
  def to_unicode(136), do: <<197, 130>> # ł
  def to_unicode(135), do: <<195, 167>> # ç
  def to_unicode(134), do: <<196, 135>> # ć
  def to_unicode(133), do: <<197, 175>> # ů
  def to_unicode(132), do: <<195, 164>> # ä
