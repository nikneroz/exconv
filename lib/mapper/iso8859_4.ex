defmodule Exconv.Mapper.Iso8859_4 do
  ...
  def to_unicode(254), do: <<197, 171>> # ū
  def to_unicode(253), do: <<197, 169>> # ũ
  ...
  def to_unicode(222), do: <<197, 170>> # Ū
  def to_unicode(221), do: <<197, 168>> # Ũ
  ...
  def to_unicode(189), do: <<197, 138>> # Ŋ
  def to_unicode(188), do: <<197, 167>> # ŧ
  def to_unicode(187), do: <<196, 163>> # ģ
  def to_unicode(186), do: <<196, 147>> # ē
  def to_unicode(185), do: <<197, 161>> # š
  def to_unicode(184), do: <<194, 184>> # ¸
  def to_unicode(183), do: <<203, 135>> # ˇ
  def to_unicode(182), do: <<196, 188>> # ļ
  def to_unicode(181), do: <<196, 169>> # ĩ
  def to_unicode(180), do: <<194, 180>> # ´
  def to_unicode(179), do: <<197, 151>> # ŗ
  ...
  def to_unicode(172), do: <<197, 166>> # Ŧ
  def to_unicode(171), do: <<196, 162>> # Ģ
  def to_unicode(170), do: <<196, 146>> # Ē
  def to_unicode(169), do: <<197, 160>> # Š
  def to_unicode(168), do: <<194, 168>> # ¨
  def to_unicode(167), do: <<194, 167>> # §
  def to_unicode(166), do: <<196, 187>> # Ļ
  def to_unicode(165), do: <<196, 168>> # Ĩ
  def to_unicode(164), do: <<194, 164>> # ¤
  def to_unicode(163), do: <<197, 150>> # Ŗ
  def to_unicode(162), do: <<196, 184>> # ĸ
