defmodule Exconv.Mapper.Gsm0338 do
  def to_unicode(127), do: <<195, 160>> # à
  def to_unicode(126), do: <<195, 188>> # ü
  def to_unicode(125), do: <<195, 177>> # ñ
  def to_unicode(124), do: <<195, 182>> # ö
  def to_unicode(123), do: <<195, 164>> # ä
  ...
  def to_unicode(96), do: <<194, 191>> # ¿
  def to_unicode(95), do: <<194, 167>> # §
  def to_unicode(94), do: <<195, 156>> # Ü
  def to_unicode(93), do: <<195, 145>> # Ñ
  def to_unicode(92), do: <<195, 150>> # Ö
  def to_unicode(91), do: <<195, 132>> # Ä
  ...
  def to_unicode(36), do: <<194, 164>> # ¤
  def to_unicode(35), do: <<35>> # #
  def to_unicode(34), do: <<34>> # "
  def to_unicode(33), do: <<33>> # !
  def to_unicode(32), do: <<32>> #  
  def to_unicode(31), do: <<195, 137>> # É
  def to_unicode(30), do: <<195, 159>> # ß
  def to_unicode(29), do: <<195, 166>> # æ
  def to_unicode(28), do: <<195, 134>> # Æ
  def to_unicode(7013), do: <<226, 130, 172>> # €
  def to_unicode(6976), do: <<124>> # |
  def to_unicode(6974), do: <<93>> # ]
  def to_unicode(6973), do: <<126>> # ~
  def to_unicode(6972), do: <<91>> # [
  def to_unicode(6959), do: <<92>> # \
  def to_unicode(6953), do: <<125>> # }
  def to_unicode(6952), do: <<123>> # {
  def to_unicode(6932), do: <<94>> # ^
  def to_unicode(6922), do: <<12>> # 
  def to_unicode(27), do: <<194, 160>> #  
  def to_unicode(26), do: <<206, 158>> # Ξ
  def to_unicode(25), do: <<206, 152>> # Θ
  def to_unicode(24), do: <<206, 163>> # Σ
  def to_unicode(23), do: <<206, 168>> # Ψ
  def to_unicode(22), do: <<206, 160>> # Π
  def to_unicode(21), do: <<206, 169>> # Ω
  def to_unicode(20), do: <<206, 155>> # Λ
  def to_unicode(19), do: <<206, 147>> # Γ
  def to_unicode(18), do: <<206, 166>> # Φ
  def to_unicode(17), do: <<95>> # _
  def to_unicode(16), do: <<206, 148>> # Δ
  def to_unicode(15), do: <<195, 165>> # å
  def to_unicode(14), do: <<195, 133>> # Å
  def to_unicode(13), do: <<13>> # 
  def to_unicode(12), do: <<195, 184>> # ø
  def to_unicode(11), do: <<195, 152>> # Ø
  def to_unicode(10), do: <<10>> # 

  def to_unicode(9), do: <<195, 167>> # ç
  def to_unicode(8), do: <<195, 178>> # ò
  def to_unicode(7), do: <<195, 172>> # ì
  def to_unicode(6), do: <<195, 185>> # ù
  def to_unicode(5), do: <<195, 169>> # é
  def to_unicode(4), do: <<195, 168>> # è
  def to_unicode(3), do: <<194, 165>> # ¥
  def to_unicode(2), do: <<36>> # $
  def to_unicode(1), do: <<194, 163>> # £
  def to_unicode(0), do: <<64>> # @
end