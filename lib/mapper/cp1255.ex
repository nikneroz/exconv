defmodule Exconv.Mapper.Cp1255 do
  ...
  def to_unicode(223), do: <<194, 152>> # 
  def to_unicode(222), do: <<194, 152>> # 
  def to_unicode(221), do: <<194, 152>> # 
  def to_unicode(220), do: <<194, 152>> # 
  def to_unicode(219), do: <<194, 152>> # 
  def to_unicode(218), do: <<194, 152>> # 
  def to_unicode(217), do: <<194, 152>> # 
  def to_unicode(216), do: <<215, 180>> # ״
  def to_unicode(215), do: <<215, 179>> # ׳
  def to_unicode(214), do: <<215, 178>> # ײ
  def to_unicode(213), do: <<215, 177>> # ױ
  def to_unicode(212), do: <<215, 176>> # װ
  def to_unicode(211), do: <<215, 131>> # ׃
  def to_unicode(210), do: <<215, 130>> # ׂ
  def to_unicode(209), do: <<215, 129>> # ׁ
  def to_unicode(208), do: <<215, 128>> # ׀
  def to_unicode(207), do: <<214, 191>> # ֿ
  def to_unicode(206), do: <<214, 190>> # ־
  def to_unicode(205), do: <<214, 189>> # ֽ
  def to_unicode(204), do: <<214, 188>> # ּ
  def to_unicode(203), do: <<214, 187>> # ֻ
  def to_unicode(202), do: <<194, 152>> # 
  def to_unicode(201), do: <<214, 185>> # ֹ
  def to_unicode(200), do: <<214, 184>> # ָ
  def to_unicode(199), do: <<214, 183>> # ַ
  def to_unicode(198), do: <<214, 182>> # ֶ
  def to_unicode(197), do: <<214, 181>> # ֵ
  def to_unicode(196), do: <<214, 180>> # ִ
  def to_unicode(195), do: <<214, 179>> # ֳ
  def to_unicode(194), do: <<214, 178>> # ֲ
  def to_unicode(193), do: <<214, 177>> # ֱ
  def to_unicode(192), do: <<214, 176>> # ְ
  ...
  def to_unicode(164), do: <<226, 130, 170>> # ₪
