defmodule Exconv.Mapper.Cp1006 do
  def to_unicode(255), do: <<239, 185, 189>> # ﹽ
  def to_unicode(254), do: <<239, 185, 188>> # ﹼ
  def to_unicode(253), do: <<239, 174, 174>> # ﮮ
  def to_unicode(252), do: <<239, 174, 176>> # ﮰ
  def to_unicode(251), do: <<239, 187, 179>> # ﻳ
  def to_unicode(250), do: <<239, 187, 178>> # ﻲ
  def to_unicode(249), do: <<239, 187, 177>> # ﻱ
  def to_unicode(248), do: <<239, 186, 139>> # ﺋ
  def to_unicode(247), do: <<239, 186, 138>> # ﺊ
  def to_unicode(246), do: <<239, 186, 137>> # ﺉ
  def to_unicode(245), do: <<239, 186, 128>> # ﺀ
  def to_unicode(244), do: <<239, 174, 170>> # ﮪ
  def to_unicode(243), do: <<239, 174, 169>> # ﮩ
  def to_unicode(242), do: <<239, 174, 168>> # ﮨ
  def to_unicode(241), do: <<239, 174, 166>> # ﮦ
  def to_unicode(240), do: <<239, 187, 173>> # ﻭ
  def to_unicode(239), do: <<239, 186, 133>> # ﺅ
  def to_unicode(238), do: <<239, 187, 167>> # ﻧ
  def to_unicode(237), do: <<239, 187, 165>> # ﻥ
  def to_unicode(236), do: <<239, 174, 158>> # ﮞ
  def to_unicode(235), do: <<239, 187, 163>> # ﻣ
  def to_unicode(234), do: <<239, 187, 161>> # ﻡ
  def to_unicode(233), do: <<239, 187, 160>> # ﻠ
  def to_unicode(232), do: <<239, 187, 159>> # ﻟ
  def to_unicode(231), do: <<239, 187, 157>> # ﻝ
  def to_unicode(230), do: <<239, 174, 148>> # ﮔ
  def to_unicode(229), do: <<239, 174, 146>> # ﮒ
  def to_unicode(228), do: <<239, 187, 155>> # ﻛ
  def to_unicode(227), do: <<239, 187, 153>> # ﻙ
  def to_unicode(226), do: <<239, 187, 151>> # ﻗ
  def to_unicode(225), do: <<239, 187, 149>> # ﻕ
  def to_unicode(224), do: <<239, 187, 147>> # ﻓ
  def to_unicode(223), do: <<239, 187, 145>> # ﻑ
  def to_unicode(222), do: <<239, 187, 144>> # ﻐ
  def to_unicode(221), do: <<239, 187, 143>> # ﻏ
  def to_unicode(220), do: <<239, 187, 142>> # ﻎ
  def to_unicode(219), do: <<239, 187, 141>> # ﻍ
  def to_unicode(218), do: <<239, 187, 140>> # ﻌ
  def to_unicode(217), do: <<239, 187, 139>> # ﻋ
  def to_unicode(216), do: <<239, 187, 138>> # ﻊ
  def to_unicode(215), do: <<239, 187, 137>> # ﻉ
  def to_unicode(214), do: <<239, 187, 133>> # ﻅ
  def to_unicode(213), do: <<239, 187, 129>> # ﻁ
  def to_unicode(212), do: <<239, 186, 191>> # ﺿ
  def to_unicode(211), do: <<239, 186, 189>> # ﺽ
  def to_unicode(210), do: <<239, 186, 187>> # ﺻ
  def to_unicode(209), do: <<239, 186, 185>> # ﺹ
  def to_unicode(208), do: <<239, 186, 183>> # ﺷ
  def to_unicode(207), do: <<239, 186, 181>> # ﺵ
  def to_unicode(206), do: <<239, 186, 179>> # ﺳ
  def to_unicode(205), do: <<239, 186, 177>> # ﺱ
  def to_unicode(204), do: <<239, 174, 138>> # ﮊ
  def to_unicode(203), do: <<239, 186, 175>> # ﺯ
  def to_unicode(202), do: <<239, 174, 140>> # ﮌ
  def to_unicode(201), do: <<239, 186, 173>> # ﺭ
  def to_unicode(200), do: <<239, 186, 171>> # ﺫ
  def to_unicode(199), do: <<239, 174, 132>> # ﮄ
  def to_unicode(198), do: <<239, 186, 169>> # ﺩ
  def to_unicode(197), do: <<239, 186, 167>> # ﺧ
  def to_unicode(196), do: <<239, 186, 165>> # ﺥ
  def to_unicode(195), do: <<239, 186, 163>> # ﺣ
  def to_unicode(194), do: <<239, 186, 161>> # ﺡ
  def to_unicode(193), do: <<239, 173, 188>> # ﭼ
  def to_unicode(192), do: <<239, 173, 186>> # ﭺ
  def to_unicode(191), do: <<239, 186, 159>> # ﺟ
  def to_unicode(190), do: <<239, 186, 157>> # ﺝ
  def to_unicode(189), do: <<239, 186, 155>> # ﺛ
  def to_unicode(188), do: <<239, 186, 153>> # ﺙ
  def to_unicode(187), do: <<239, 173, 168>> # ﭨ
  def to_unicode(186), do: <<239, 173, 166>> # ﭦ
  def to_unicode(185), do: <<239, 186, 151>> # ﺗ
  def to_unicode(184), do: <<239, 186, 149>> # ﺕ
  def to_unicode(183), do: <<239, 186, 147>> # ﺓ
  def to_unicode(182), do: <<239, 173, 152>> # ﭘ
  def to_unicode(181), do: <<239, 173, 150>> # ﭖ
  def to_unicode(180), do: <<239, 186, 145>> # ﺑ
  def to_unicode(179), do: <<239, 186, 143>> # ﺏ
  def to_unicode(178), do: <<239, 186, 142>> # ﺎ
  def to_unicode(177), do: <<239, 186, 142>> # ﺎ
  def to_unicode(176), do: <<239, 186, 141>> # ﺍ
  def to_unicode(175), do: <<239, 186, 129>> # ﺁ
  def to_unicode(174), do: <<216, 159>> # ؟
  def to_unicode(173), do: <<194, 173>> # ­
  def to_unicode(172), do: <<216, 155>> # ؛
  def to_unicode(171), do: <<216, 140>> # ،
  def to_unicode(170), do: <<219, 185>> # ۹
  def to_unicode(169), do: <<219, 184>> # ۸
  def to_unicode(168), do: <<219, 183>> # ۷
  def to_unicode(167), do: <<219, 182>> # ۶
  def to_unicode(166), do: <<219, 181>> # ۵
  def to_unicode(165), do: <<219, 180>> # ۴
  def to_unicode(164), do: <<219, 179>> # ۳
  def to_unicode(163), do: <<219, 178>> # ۲
  def to_unicode(162), do: <<219, 177>> # ۱
  def to_unicode(161), do: <<219, 176>> # ۰
